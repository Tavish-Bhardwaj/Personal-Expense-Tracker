          ...
          {pathname !== "/auth/login" &&
            ...
            pathname !== "/" && (
              <div className="flex flex-col space-y-4">
                <Link href="/dashboard" onClick={handleLinkClick} className="text-lg font-medium text-foreground dark:text-primary-foreground hover:text-primary transition">
                  Dashboard
                </Link>
                <Link href="/expenses" onClick={handleLinkClick} className="text-lg font-medium text-foreground dark:text-primary-foreground hover:text-primary transition">
                  Expenses
                </Link>
                <Link href="/addCategory" onClick={handleLinkClick} className="text-lg font-medium text-foreground dark:text-primary-foreground hover:text-primary transition">
                  Categories
                </Link>
                <Link href="/profile" onClick={handleLinkClick} className="text-lg font-medium text-foreground dark:text-primary-foreground hover:text-primary transition">
                  Profile
                </Link>
              </div>
            )}
